...
const EMPTY_SEARCH = require('./emptySearch.jpg');
...
const HYPERLIQUID = {
  uri: `${S3_BUCKET_URL_ICONS}/hyperliquid.png`,
};
const HYPERLIQUID_LOGO_TEXT = {
  uri: `${S3_BUCKET_URL_ICONS}/hyperLiquidLogoText.png`,
};
const CARD_APP_INTRO_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppIntroIcon.png`,
};
const CARD_APP_ID_VERIFICATION_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppIdVerificationIcon.png`,
};
const CARD_APP_ACTIVATE_CARD_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppActivateCardIcon.png`,
};
const CARD_APP_GIFT_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppGiftIcon.png`,
};
const CARD_APP_REFERRAL_SUCCESS_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppReferralSuccessIcon.png`,
};
const CARD_APP_FACE_RECOGNITION_FRAME = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppFaceRecognitionFrame.png`,
};
const CARD_APP_VERIFICATION_IN_PROGRESS_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppVerificationInProgressIcon.png`,
};
const CARD_APP_ADDITIONAL_DOCUMENT_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppAdditionalDocumentIcon.png`,
};
const CARD_APP_DOCUMENT_REVIEW_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppDocumentReviewIcon.png`,
};
const CARD_APP_VERIFICATION_COMPLETED_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppVerificationCompletedIcon.png`,
};
const CARD_APP_VERIFICATION_FAILED_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/cardAppVerificationFailedIcon.png`,
};
const CYPHER_VIRTUAL_CARD = {
  uri: `${S3_BUCKET_URL_ICONS}/cypherVirtualCard.png`,
};
...
const OFFER_CODE_TAG_GREEN = {
  uri: `${S3_BUCKET_URL_ICONS}/offerCodeTagGreen.png`,
};
const REFERRAL_CODE_HERO = {
  uri: `${S3_BUCKET_URL_ICONS}/referralCodeHero.png`,
};
const REFERRAL_CODE_3D_ICON = {
  uri: `${S3_BUCKET_URL_ICONS}/referralCode3dIcon.png`,
};
const GREEN_CHECK_MARK_BLACK_BORDER = {
  uri: `${S3_BUCKET_URL_ICONS}/greenCheckMarkBlackBorder.png`,
};
const VIRTUAL_CARD_VERTICAL_SPIN = {
  uri: `${S3_BUCKET_URL_ICONS}/virtualCardVerticalSpin.mp4`,
};
const VIRTUAL_CARD_HORIZONTAL_SPIN = {
  uri: `${S3_BUCKET_URL_ICONS}/virtualCardHorizontalSpin.mp4`,
};
const CYPR_TOKEN_SPIN_WITH_BG = {
  uri: `${S3_BUCKET_URL_ICONS}/cyprTokenSpinWithBg.mp4`,
};
const COUPON_BORDER = {
  uri: `${S3_BUCKET_URL_ICONS}/couponBorder.png`,
};
const CYPR_TOKEN_STACK = {
  uri: `${S3_BUCKET_URL_ICONS}/cyprTokenStack.png`,
};
const INVITE_FRIEND_PERSON = {
  uri: `${S3_BUCKET_URL_ICONS}/inviteFriendPerson.png`,
};
const SHOP_3D = {
  uri: `${S3_BUCKET_URL_ICONS}/shop3d.png`,
};
const CYPR_TOKEN_WITH_BASE_CHAIN = {
  uri: `${S3_BUCKET_URL_ICONS}/cyprTokenWithBaseChain.png`,
};
const CYPR_TOKEN_LOCKED = {
  uri: `${S3_BUCKET_URL_DAPPS}/cyprTokenLocked.png`,
};
...
const MSITE_AIRDROP_CHART_BG = {
  uri: `${S3_BUCKET_URL_DAPPS}/msiteAirdropChartBg.png`,
};
const MSITE_AIRDROP_ELIGIBILITY_BG = {
  uri: `${S3_BUCKET_URL_DAPPS}/msiteAirdropEligibilityBg.png`,
};
...
export const AppImagesMap = {
  common: {
    ...
    HYPERLIQUID,
    CARD_APP_INTRO_ICON,
    CARD_APP_ID_VERIFICATION_ICON,
    CARD_APP_ACTIVATE_CARD_ICON,
    CARD_APP_GIFT_ICON,
    CARD_APP_REFERRAL_SUCCESS_ICON,
    CARD_APP_FACE_RECOGNITION_FRAME,
    CARD_APP_VERIFICATION_IN_PROGRESS_ICON,
    CARD_APP_ADDITIONAL_DOCUMENT_ICON,
    CARD_APP_DOCUMENT_REVIEW_ICON,
    CARD_APP_VERIFICATION_COMPLETED_ICON,
    ...
    WALLET_CONNECT_ICON,
    OFFER_CODE_TAG_GREEN,
    REFERRAL_CODE_HERO,
    REFERRAL_CODE_3D_ICON,
    GREEN_CHECK_MARK_BLACK_BORDER,
    VIRTUAL_CARD_VERTICAL_SPIN,
    VIRTUAL_CARD_HORIZONTAL_SPIN,
    CYPR_TOKEN_SPIN_WITH_BG,
    COUPON_BORDER,
    CYPR_TOKEN_STACK,
    INVITE_FRIEND_PERSON,
    SHOP_3D,
...
enum AppImages {
  ...
  MSITE_AIRDROP_CHART_BG = 'MSITE_AIRDROP_CHART_BG',
  ...
  CARD_APP_INTRO_ICON = 'CARD_APP_INTRO_ICON',
  CARD_APP_ID_VERIFICATION_ICON = 'CARD_APP_ID_VERIFICATION_ICON',
  CARD_APP_ACTIVATE_CARD_ICON = 'CARD_APP_ACTIVATE_CARD_ICON',
  CARD_APP_GIFT_ICON = 'CARD_APP_GIFT_ICON',
  CARD_APP_REFERRAL_SUCCESS_ICON = 'CARD_APP_REFERRAL_SUCCESS_ICON',
  CARD_APP_FACE_RECOGNITION_FRAME = 'CARD_APP_FACE_RECOGNITION_FRAME',
  CARD_APP_VERIFICATION_IN_PROGRESS_ICON = 'CARD_APP_VERIFICATION_IN_PROGRESS_ICON',
  CARD_APP_ADDITIONAL_DOCUMENT_ICON = 'CARD_APP_ADDITIONAL_DOCUMENT_ICON',
  CARD_APP_DOCUMENT_REVIEW_ICON = 'CARD_APP_DOCUMENT_REVIEW_ICON',
  CARD_APP_VERIFICATION_COMPLETED_ICON = 'CARD_APP_VERIFICATION_COMPLETED_ICON',
  ...
  OFFER_CODE_TAG_GREEN = 'OFFER_CODE_TAG_GREEN',
  REFERRAL_CODE_HERO = 'REFERRAL_CODE_HERO',
  REFERRAL_CODE_3D_ICON = 'REFERRAL_CODE_3D_ICON',
  GREEN_CHECK_MARK_BLACK_BORDER = 'GREEN_CHECK_MARK_BLACK_BORDER',
  VIRTUAL_CARD_VERTICAL_SPIN = 'VIRTUAL_CARD_VERTICAL_SPIN',
  VIRTUAL_CARD_HORIZONTAL_SPIN = 'VIRTUAL_CARD_HORIZONTAL_SPIN',
  CYPR_TOKEN_SPIN_WITH_BG = 'CYPR_TOKEN_SPIN_WITH_BG',
  COUPON_BORDER = 'COUPON_BORDER',
  CYPR_TOKEN_STACK = 'CYPR_TOKEN_STACK',
  INVITE_FRIEND_PERSON = 'INVITE_FRIEND_PERSON',
  SHOP_3D = 'SHOP_3D',
