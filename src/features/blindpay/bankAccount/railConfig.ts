...
const US_ADDRESS_FIELDS: FieldDef[] = [
  { key: 'addressLine1', label: 'Street Address', placeholder: 'Street address', type: 'text', required: true },
  { key: 'addressLine2', label: 'Apt / Suite', placeholder: 'Apartment, Suite (optional)', type: 'text' },
  ...
  buildRail({
    ...
    steps: [{
      ...
      fields: [
        ...
        { key: 'pixSafeBankCode', label: 'Bank Code', placeholder: '4-8 digits', type: 'text', required: true, keyboardType: 'number-pad', maxLength: 8, regex: /^\d{4,8}$/, regexMessage: 'Must be 4-8 digits' },
  ...
  buildRail({
    ...
    steps: [{
      ...
      fields: [
        ...
        { key: 'beneficiaryName', label: 'Beneficiary Name', placeholder: 'Full legal name', type: 'text', required: true, maxLength: 128 },
        { key: 'speiInstitutionCode', label: 'Institution Code', placeholder: '5-digit code', type: 'text', keyboardType: 'number-pad', maxLength: 5, regex: /^\d{5}$/, regexMessage: 'Must be exactly 5 digits' },
      ],
    }],
  }),
  buildRail({
  ...
  buildRail({
    ...
    steps: [
      ...
      },
      {
        ...
        fields: [
          { key: 'swiftBeneficiaryAddressLine1', label: 'Beneficiary Address', placeholder: 'Street address (optional)', type: 'text' },
          { key: 'swiftBeneficiaryCity', label: 'Beneficiary City', placeholder: 'City (optional)', type: 'text' },
          { key: 'swiftBeneficiaryCountry', label: 'Beneficiary Country', placeholder: 'e.g. US', type: 'text', autoCapitalize: 'characters', maxLength: 2 },
          { key: 'swiftBankName', label: 'Bank Name', placeholder: 'Bank name (optional)', type: 'text' },
          { key: 'swiftBankCountry', label: 'Bank Country', placeholder: 'e.g. US', type: 'text', autoCapitalize: 'characters', maxLength: 2 },
          { key: 'swiftIntermediaryBankSwiftCodeBic', label: 'Intermediary SWIFT', placeholder: 'SWIFT code (optional)', type: 'text', autoCapitalize: 'characters', maxLength: 11 },
          { key: 'swiftIntermediaryBankName', label: 'Intermediary Bank Name', placeholder: 'Bank name (optional)', type: 'text' },
          { key: 'swiftIntermediaryBankCountry', label: 'Intermediary Country', placeholder: 'e.g. US', type: 'text', autoCapitalize: 'characters', maxLength: 2 },
        ],
      },
    ],
  }),
