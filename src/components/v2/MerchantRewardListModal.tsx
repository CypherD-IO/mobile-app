...
interface MerchantRewardListModalProps {
  isVisible: boolean;
...
const MerchantRewardListModal: React.FC<MerchantRewardListModalProps> = ({
  isVisible,
  setIsVisible,
  onMerchantPress,
}) => {
  ...
  return (
    <CyDBottomSheet
      ...
      snapPoints={['80%', '95%']}
      initialSnapIndex={-1}
      title='Merchants on cypher'
      showCloseButton={true}
      scrollable={true}
      onClose={handleModalClose}
      onOpen={() => console.log('Merchant list sheet opened')}
...
export default MerchantRewardListModal;
