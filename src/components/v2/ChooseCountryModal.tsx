...
interface Props {
    ...
    selectedCountryState: [ICountry, React.Dispatch<React.SetStateAction<ICountry>>]
}


const ChooseCountryModal = ({ isModalVisible, setModalVisible, selectedCountryState }: Props) => {
