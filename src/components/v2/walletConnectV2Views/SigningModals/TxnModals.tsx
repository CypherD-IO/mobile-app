...
export const RenderTypedTransactionSignModal = ({ dAppInfo, chain, method, messageParams }: { dAppInfo: IDAppInfo | undefined, chain: Chain | undefined, method: string, messageParams: any }) => {
  return (
    <CyDView>
      <CyDView>
        {dAppInfo
