        ...
        <CyDView className={'bg-white pb-[30px] rounded-[20px] max-h-[90%]'}>
          ...
          <CyDView className='flex mt-[5%] flex-row justify-center items-center '>
            ...
            <CyDView className='flex mt-[5%] justify-center items-center '>
              <CyDText className='text-center font-manrope text-[20px] font-extrabold  '>
                {t<string>('DEBIT_CARD_TRANSACTION')}
              </CyDText>
              <CyDText className='text-center font-manrope text-[12px] font-extrabold text-successTextGreen'>
                {t<string>('SUCCESSFUL')}
              </CyDText>
            </CyDView>
          </CyDView>
          <CyDScrollView className='flex flex-col px-[40px]'>
            <CyDView className='flex flex-row mt-[10%] justify-start items-center'>
              <CyDText className='font-manrope text-[16px] mt-[3px] w-[30%]  '>
                {t<string>('DATE')}
              </CyDText>
              <CyDText className='text-center font-manrope text-[14px] mt-[4.5px] font-bold  '>
            ...
            <CyDView className='flex flex-row mt-[10%] justify-start'>
              ...
              <CyDText className='text-center font-manrope text-[14px] mt-[5px] font-bold  '>{`${amount} ${symbol}`}</CyDText>
            </CyDView>
            <CyDView className='flex flex-row mt-[10%] justify-start'>
              <CyDText className='font-manrope text-[16px] mt-[3px] w-[30%]  '>
                {t<string>('RECEIVED')}
              </CyDText>
              <CyDText className='text-center font-manrope text-[14px] mt-[5px] font-bold mt-[5px]  '>{`$${amountInUsd}`}</CyDText>
            </CyDView>
            <CyDView className='flex flex-row mt-[10%] justify-start'>
              <CyDText className='font-manrope text-[16px] mt-[3px] w-[30%]  '>
                {t<string>('GAS_FEE')}
              </CyDText>
              <CyDText className='text-center font-manrope text-[14px] mt-[5px] font-bold mt-[5px]  '>{`${gasAmount} ${gasAmount === 'Not Available' ? '' : 'USD'}`}</CyDText>
            </CyDView>
            <CyDTouchView
              ...
              <CyDText className='text-center font-manrope text-[14px] mt-[5px] font-bold mt-[3px]  '>
                {txnHash
            ...
            <CyDView className='flex flex-row mt-[10%] justify-start'>
              ...
              <CyDText className='text-center font-manrope text-[14px] mt-[3px] font-bold mt-[5px]  '>{`${String(round((parseFloat(amountInUsd) - parseFloat(gasAmount === 'Not Available' ? '0' : gasAmount)) / parseFloat(amount), 6))} USD`}</CyDText>
            </CyDView>
