      ...
      <CyDView
        ...
        <CyDView className={'flex flex-row mt-[40px]'}>
          ...
          <CyDView className={' flex flex-row'}>
            <CyDText
              className={
                ' font-medium text-[16px] ml-[4px] text-primaryTextColor'
              }>
              {'APR ' + data.apr + '%'}
            </CyDText>
          </CyDView>
        ...
        <CyDView className={'flex flex-row mt-[20px]'}>
          <CyDImage
            source={AppImages[data.logo + '_LOGO']}
        ...
        {typeOfAction !== 'unstake' && (
          <Button
            onPress={() => {
              stakingValidators.dispatchStaking({
                value: { typeOfDelegation: DELEGATE },
              });
              onPress();
            }}
            title={t('DELEGATE')}
        ...
        {data.balance !== BigInt(0) && (
          <Button
            onPress={() => {
              stakingValidators.dispatchStaking({
                value: { typeOfDelegation: UN_DELEGATE },
              });
              onPress();
            }}
            title={t('UNDELEGATE')}
