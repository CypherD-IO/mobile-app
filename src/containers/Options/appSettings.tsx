...
const renderSettingsData = (item: IAppSettingsData, navigation: any) => {
  return (
    <CyDView className={'mx-[24px]'} >
      <CyDTouchView className={'flex flex-row justify-between pl-[15px] py-[24px]'} onPress={() => { navigation.navigate(item.navigateTo); }}>
        ...
        {item.index === 1 ? <CyDImage source={AppImages.OPTIONS_ARROW} className={'w-[11%] h-[15px]'} resizeMode={'contain'} /> : <CyDView></CyDView>}
      </CyDTouchView>
