...
const renderSeedPhrase = (text: string, index: number) => {
  return (
    <CyDView
      ...
      <CyDText className={'text-[17px] text-center text-[#929292] font-nunito'}>
        {++index}
      </CyDText>
      <CyDText
        className={
          'text-[17px] text-center text-[#434343] font-nunito ml-[5px]'
        }>
        {text}
      </CyDText>
    </CyDView>
      ...
      <CyDScrollView className={'bg-white h-full w-full relative '}>
        <CyDView className={'flex justify-center items-center'}>
          <CyDView
            ...
            <CyDText
              className={'text-[15px] text-center text-[#434343] font-nunito'}>
              {t('SEED_PHRASE_SUBTITLE')}
            </CyDText>
          </CyDView>
          <CyDView
            className={'flex justify-center items-center my-[20px] mt-[30px]'}>
            <QRCode
              value={seedPhrase}
              // codeStyle='dot'
