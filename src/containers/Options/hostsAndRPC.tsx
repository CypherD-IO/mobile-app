    ...
    <CyDScrollView className={'bg-white h-full px-[24px] pt-[20px]'}>
      <CyDKeyboardAwareScrollView>
          ...
          <CyDView>
            <CyDView className={'mt-[18px]'}>
              ...
              <CyDView className={'flex flex-row justify-between items-center'}>
                <CyDTextInput
                  className={clsx(
                    'mt-[10px] border-[1px] border-inputBorderColor rounded-[5px] p-[12px] text-[18px] font-manrope text-primaryTextColor  w-[90%]',
                  )}
                  editable={false}
        ...
        <CyDView className={'mt-[18px]'}>
          ...
          <CyDTextInput
            className={clsx(
              'mt-[10px] border-[1px] border-inputBorderColor rounded-[5px] p-[12px] text-[18px] font-manrope text-primaryTextColor',
            )}
            editable={devMode}
