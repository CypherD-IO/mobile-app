      ...
      <CyDView className='bg-cardBgTo px-[12px] py-[24px] m-[2px] mb-[6px] rounded-[16px]'>
        ...
        {/* {!isPhoneVerified && (
          <CyDTouchView
            ...
            className='flex flex-row align-center m-[2px] py-[15px] bg-white rounded-[6px]'>
            <CyDImage
        ...
        {card.status === CardStatus.ACTIVE && card.type === 'physical' && (
          <CyDTouchView
            onPress={() =>
              navigation.navigate(screenTitle.CARD_SET_PIN_SCREEN, {
                currentCardProvider: cardProvider,
            ...
            className='flex flex-row items-center m-[2px] py-[14px] mt-[12px] bg-white rounded-[6px]'>
            <CyDImage
              source={AppImages.OPTIONS_ARROW}
              className={'w-[15%] h-[18px]'}
              resizeMode={'contain'}
        ...
        <CyDTouchView
          ...
          <CyDView className='flex flex-col justify-between'>
            <CyDText className='text-[16px] font-bold'>
              {t<string>('UPDATE_CONTACT_DETAILS')}
            </CyDText>
            <CyDText className='text-[14px] font-bold'>
