    ...
    try {
      ...
      if (!response.isError) {
        ...
        const errorObject = {
          ...
          currentCardProvider,
          message:
            'isError=true when trying to sendOtp in ShippingDetailsOTPScreen.',
        };
      ...
      const errorObject = {
        ...
        currentCardProvider,
        message:
          'Error caught when trying to sendOtp in ShippingDetailsOTPScreen.',
      };
      Sentry.captureException(errorObject);
      showModal('state', {
        type: 'error',
    ...
    try {
      ...
      if (!response.isError) {
        ...
        const errorObject = {
          ...
          data,
          message:
            'isError=true when trying to submit physical card upgrade infomation.',
        };
        showModal('state', {
          type: 'error',
          title: t('FAILURE'),
      ...
      const errorObject = {
        ...
        data,
        message:
          'Error when trying to submit physical card upgrade infomation.',
      };
      showModal('state', {
        type: 'error',
        title: t('FAILURE'),
