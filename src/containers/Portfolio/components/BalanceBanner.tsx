...
import { CyDAnimatedView, CyDFastImage, CyDImageBackground, CyDSafeAreaView, CyDText, CyDTouchView, CyDView } from '../../../styles/tailwindStyles';
...
export const BalanceBanner = ({ isVerifyCoinChecked, getAllChainBalance, scrollY }: BalanceBannerProps) => {
  ...
  return (
    <CyDSafeAreaView className='-z-10'>
      <CyDAnimatedView className={`h-[${H_BALANCE_BANNER}px] absolute top-0 w-full justify-center`} style={animatedStyles}>
