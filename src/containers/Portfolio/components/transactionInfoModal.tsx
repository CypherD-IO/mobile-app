    ...
    const RenderTransactionInfo = () => {
      if (type === TransactionType.SWAP) {
        ...
        return (
          <CyDView
            className={clsx(
              'flex flex-row flex-wrap w-[100%] my-[3%] item-center justify-center',
            )}>
            <CyDView className='flex flex-row items-center'>
              {tokenIcon && (
                <CyDImage
              ...
              {token ? (
                <CyDView className='flex flex-col'>
                  ...
                  {blockchain && (
                    <CyDView className='flex flex-row justify-center items-center'>
                      <CyDFastImage
                        className='h-[10px] w-[10px] mr-[5px] rounded-full'
                        resizeMode='contain'
                        source={chainImg}
                      />
                      <CyDText className='text-[12px] mt-[2px]'>
        ...
        return (
          <CyDView
            className={clsx(
              'flex flex-row w-[100%] my-[3%] item-center justify-between',
            )}>
                ...
                {blockchain && (
                  <CyDView className='flex flex-row justify-center items-center '>
                    <CyDFastImage
                      ...
                      source={chainImg}
                    />
                    <CyDText className='text-[12px] mt-[2px]'>{chain}</CyDText>
                  </CyDView>
                )}
              </CyDView>
            </CyDView>
