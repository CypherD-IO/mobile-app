...
const resources = {
  en: {
    translation: {
      ...
      ACCOUNT_NAME_PH: "e.g. Dad's SWIFT account",
      ADD_ACCOUNT: 'Add Account',
      ADD_BANK_ACCOUNT: 'Add Bank Account',
      BANK_ACCOUNT_ADDED: 'Bank account added successfully',
      BANK_DETAILS: 'Bank Details',
      BANKING_PARTNER: 'Banking Partner',
      BLINDPAY_ACCOUNT_PURPOSE: 'Account purpose',
      BLINDPAY_ACCOUNT_PURPOSE_OTHER:
        'More about account purpose (optional)',
      BLINDPAY_ACCOUNT_PURPOSE_PH: 'e.g. Personal savings',
      BLINDPAY_ADDITIONAL_REVIEW: 'Additional Review',
      BLINDPAY_ADDITIONAL_REVIEW_DESC:
        "We're currently processing your document with care.",
      BLINDPAY_ADDRESS_SUB: 'Use the address same as in your documents',
      BLINDPAY_ADDRESS_TITLE: 'Verify your address',
      BLINDPAY_APARTMENT: 'Apartment, Suite, etc (if applicable)',
      BLINDPAY_BACK_SIDE: 'Back Side',
      BLINDPAY_BASIC_DETAILS_SUB:
        'Please provide a few details about yourself so we can get your account set up smoothly.',
      BLINDPAY_BASIC_DETAILS_TITLE: 'Basic Details',
      BLINDPAY_CAMERA_DENIED:
        'Camera permission is required. Please enable it in Settings.',
      BLINDPAY_CAPTURE_FAILED: 'Failed to capture photo.',
      BLINDPAY_CAPTURE_HINT: 'Capture or upload a photo of your document',
      BLINDPAY_CAPTURE_HINT_SHORT: 'Capture or upload a photo',
      BLINDPAY_CAPTURE_INSTRUCTION:
        'Please take a clear photo of your ID card, ensuring that the text is readable and well-lit.',
      BLINDPAY_CAPTURE_SUBTITLE: 'Take a clear photo of your document',
      BLINDPAY_DO_NOT_TITLE: 'Do Not Submit',
      BLINDPAY_DOC_TYPE_SUB:
        'This input helps us get to know our users better and ensures the cypher stays secure for everyone.',
      BLINDPAY_DOC_TYPE_TITLE: 'Document Type',
      ...
      BLINDPAY_DOC_VERIFY_TITLE: 'Document Verification',
      BLINDPAY_DOC_VERIFY_WARNING:
        'Also, make sure the country you choose matches your documents.',
      BLINDPAY_EMAIL_ADDRESS_LABEL: 'Email Address',
      ...
      BLINDPAY_EMAIL_PLACEHOLDER: 'name@example.com',
      ...
      BLINDPAY_ENHANCED_KYC_TITLE: 'Enhanced verification required',
      BLINDPAY_FIELD_REQUIRED: 'This field is required',
      BLINDPAY_FREE_TX: '\uD83C\uDF89 Your First 3 transactions are free',
      BLINDPAY_FRONT_SIDE: 'Front Side',
      BLINDPAY_ID_BACK: 'ID document - back',
      BLINDPAY_ID_DOC: 'ID Document',
      BLINDPAY_ID_FRONT: 'ID document - front / main page',
      BLINDPAY_ID_ISSUING_COUNTRY: 'ID issuing country',
      BLINDPAY_ID_SUB:
        'Upload clear photos or PDFs. Passport only needs the photo page.',
      BLINDPAY_ID_TITLE: 'Government ID',
      BLINDPAY_IDENTITY_DOC: 'Identity Document',
      BLINDPAY_IN_PROGRESS: 'In progress',
      ...
      BLINDPAY_KYC_APPROVED_TITLE: 'Verification Completed',
      BLINDPAY_KYC_FAILED: 'Verification Failed',
      BLINDPAY_KYC_FAILED_DESC:
        'We regret to inform you that your KYC verification has not been approved by our banking partner.',
      BLINDPAY_KYC_IN_PROGRESS: 'Verification In-Progress',
      ...
      BLINDPAY_KYC_STATUS: 'KYC Status',
      BLINDPAY_NO_CAMERA: 'Camera not available',
      ...
      BLINDPAY_OPEN_CAMERA: 'Open Camera',
      BLINDPAY_PHOTO_REQ_TITLE: 'Photo Requirements',
      BLINDPAY_PHOTO_UPLOADED: 'Photo uploaded',
      BLINDPAY_PLACE_ID: 'Just place your ID into this frame.',
      BLINDPAY_POA_DOC: 'Proof of address',
      BLINDPAY_POA_SUB:
        'Please upload one document that serves as proof of address. This needs to be the same address as the one provided above.',
      BLINDPAY_POA_TITLE: 'Proof of address',
      BLINDPAY_POA_UPLOAD: 'Proof of address document',
      BLINDPAY_PREVIEW_INSTRUCTION:
        'Make sure lighting is good and any lettering is clear before continuing with the application',
      BLINDPAY_PURPOSE_EXPLAIN: 'Please explain',
      BLINDPAY_PURPOSE_EXPLAIN_PH:
        'Describe the purpose of your transactions...',
      BLINDPAY_PURPOSE_OF_TX: 'Purpose of transactions',
      BLINDPAY_PURPOSE_OF_TX_DETAIL: 'Additional details (optional)',
      BLINDPAY_PURPOSE_TX_SUB:
        'Tell us the primary purpose for your transactions.',
      BLINDPAY_PURPOSE_TX_TITLE: 'Purpose of Transactions',
      BLINDPAY_RETAKE: 'Retake photo',
      BLINDPAY_REVIEW_ADDR: 'Address',
      BLINDPAY_REVIEW_COUNTRY: 'Country',
      BLINDPAY_REVIEW_DOB: 'DOB',
      BLINDPAY_REVIEW_EMAIL: 'Email',
      BLINDPAY_REVIEW_LOCATION: 'Location',
      BLINDPAY_REVIEW_MISSING: 'Missing',
      BLINDPAY_REVIEW_NAME: 'Name',
      BLINDPAY_REVIEW_PERSONAL: 'Personal Details',
      BLINDPAY_REVIEW_PHONE: 'Phone',
      BLINDPAY_REVIEW_STREET: 'Street',
      BLINDPAY_REVIEW_SUB: 'Check your details before submitting.',
      BLINDPAY_REVIEW_TAX: 'Tax Information',
      BLINDPAY_REVIEW_TAX_ID: 'Tax ID',
      BLINDPAY_REVIEW_TITLE: 'Review & submit',
      BLINDPAY_REVIEW_UPLOADED: 'Uploaded',
      BLINDPAY_REVIEW_WAIT:
        'The additional review generally requires 3 to 5 business days for completion.',
      BLINDPAY_SELECT_COUNTRY: 'Select country',
      BLINDPAY_SELFIE_CAPTURE_TITLE: 'Selfie verification',
      ...
      BLINDPAY_SELFIE_INTRO_TITLE: 'Selfie Verification',
      ...
      BLINDPAY_SELFIE_LABEL: 'Selfie',
      BLINDPAY_SELFIE_SUB:
        'Upload a clear photo of your face. Remove hats or sunglasses.',
      BLINDPAY_SELFIE_TITLE: 'Selfie',
      BLINDPAY_SELFIE_UPLOAD: 'Selfie photo',
      BLINDPAY_SNAP: 'Snap a photo',
      BLINDPAY_SOF_LABEL: 'Source of Funds',
      BLINDPAY_SOF_SUB:
        'Upload a document that verifies your source of funds for enhanced verification.',
      BLINDPAY_SOF_TITLE: 'Source of Funds',
      BLINDPAY_SOF_TYPE: 'Document type',
      BLINDPAY_SOF_UPLOAD: 'Upload document',
      BLINDPAY_START_SENDING: 'Start sending money',
      BLINDPAY_STEP_1_SUBTITLE:
        'Share a few basic details to help us get to know you.',
      BLINDPAY_STEP_1_TITLE: 'Verify your Basic Details',
      BLINDPAY_STEP_2_SUBTITLE:
        'Upload a valid ID to complete your KYC verification.',
      BLINDPAY_STEP_2_TITLE: 'Verify Your Identity',
      BLINDPAY_STEP_3_SUBTITLE:
        'Receive your card and activate it in just a few taps!',
      BLINDPAY_STEP_3_TITLE: 'Start Sending money',
      BLINDPAY_STREET_ADDRESS: 'Street address',
      BLINDPAY_TAX_ID_LABEL: 'Tax ID',
      BLINDPAY_TAX_SUB:
        'Enter your tax identification number for your country (e.g. SSN, CPF, RFC).',
      BLINDPAY_TAX_TITLE: 'Tax information',
      BLINDPAY_TOS_COMPLETE: 'Terms accepted. Continue with verification.',
      BLINDPAY_TOS_URL_MISSING: 'Terms URL is unavailable. Please try again.',
      BLINDPAY_UPLOAD_INSTEAD: 'Upload a photo instead',
      BLINDPAY_UPLOAD_PHOTO: 'Upload a photo',
      BLINDPAY_WAIT_TIME:
        'Please wait for 3-10 minutes as we complete this process.',
      BLINDPAY_ZOD_ACCOUNT_PURPOSE_OTHER:
        'Please specify the account purpose',
      BLINDPAY_ZOD_AGE: 'You must be at least 18 years old',
      BLINDPAY_ZOD_COUNTRY: 'Select a country',
      BLINDPAY_ZOD_DATE_INVALID: 'Enter a valid date of birth',
      BLINDPAY_ZOD_EMAIL: 'Enter a valid email address',
      BLINDPAY_ZOD_PHONE: 'Enter a valid phone number (e.g. +1234567890)',
      BLINDPAY_ZOD_PURPOSE_EXPLAIN: 'Please explain the purpose',
      BLINDPAY_ZOD_SELECT_ID_DOC: 'Select an ID document type',
      BLINDPAY_ZOD_SELECT_POA_DOC: 'Select a proof of address document',
      BLINDPAY_ZOD_SELECT_SOF_DOC: 'Select a source of funds document',
      BLINDPAY_ZOD_STATE:
        'Enter a 2-letter state/province code (e.g. CA, NY, ON)',
      BLINDPAY_ZOD_UPLOAD_BACK: 'Upload the back of your ID',
      BLINDPAY_ZOD_UPLOAD_FRONT: 'Upload the front of your ID',
      BLINDPAY_ZOD_UPLOAD_POA: 'Upload a document',
      BLINDPAY_ZOD_UPLOAD_SELFIE: 'Upload a selfie',
      BLINDPAY_ZOD_UPLOAD_SOF: 'Upload a source of funds document',
      BLINDPAY_ZOD_URL: 'Invalid file URL',
      CITY: 'City',
      CREATE_VA: 'Create Virtual Account',
      CREATED: 'Created',
      EDIT: 'Edit',
      EDIT_DETAILS: 'Edit Details',
      EDIT_VA: 'Edit Account',
      FIELD_REQUIRED: 'All fields are required',
      FIRST_NAME: 'First Name',
      GO_HOME: 'Go Home',
      LAST_NAME: 'Last Name',
      NO_VA: 'No virtual accounts yet. Create one to start receiving funds.',
      ...
      SELECT_RAIL: 'Select a payment method',
      STATE_PROVINCE: '2-letter state/province code (e.g. CA, NY, ON)',
      UPLOADING: 'Uploading...',
      VA_COMING_SOON: 'Coming Soon',
      VA_COMING_SOON_DESC:
        "Virtual accounts are currently available for US residents only. We're working on expanding to more countries soon.",
      VA_DESC: 'Manage your virtual bank accounts for receiving funds',
      VA_DETAIL: 'Account Details',
      VA_NOT_FOUND: 'Virtual account not found',
      VA_UPDATED: 'Virtual account updated',
      ...
      LINK_ANOTHER_WALLET: 'Link Another Wallet',
      ...
      YOU_ARE_SHORT_OF: 'You are short of',
      PLEASE_LOAD_YOUR_CARD: 'Please load your card',
      ...
      CARD_NOTIFICATIONS_SETTINGS: 'Card Notifications Settings',
      NEW_ADDRESS_TO_LINK: 'New address to link',
      WALLET_NAME: 'Wallet Name',
      UNLINK: 'Unlink',
      UNLINK_WALLET_AUTH: 'Unlink Wallet Authentication',
      CONFIRM_WITHDRAWAL: 'Confirm Withdrawal',
      AUTO_LOAD_PREVIEW: 'Auto Load Preview',
      AUTO_LOAD: 'Auto Load',
      ...
      ERROR_WHILE_CANCEL_SUBSCRIPTION: 'Error while cancelling subscription',
      ...
      SELECT_AN_EMOJI: 'Select an emoji',
      TAG_NAME: 'Tag name',
