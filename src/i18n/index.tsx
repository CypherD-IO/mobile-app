...
const resources = {
  en: {
    translation: {
      ...
      IMPORT_WALLET_SUB_MSG: 'Enter your seed phrase to import your wallet to Cypher. It is 12 words that you can copy from your other wallet.',
      ENTER_KEY_MANUALLY: 'ENTER KEY MANUALLY',
      IMPORT_KEY_FROM_ICLOUD: 'IMPORT KEY FROM ICLOUD',
      ENTER_SEED_PHRASE: 'Enter Seed Phrase',
      SUBMIT: 'SUBMIT',
      GET_QUOTE: 'Get Quote',
      ENTER_KEY_PLACEHOLDER: 'Enter your key (12 words)',
      ...
      CHAIN_NOT_SUPPORTED: 'This chain is not supported. Try other chains',
      ...
      BRIDGE: 'Bridge',
      BRIDGE_SHORTCUTS_SUBTITLE: 'Exchange tokens between chains',
      ...
      CONFIRM_SEED_PHRASE_INFO: 'Please select each phrase in order to make sure it is correct',
      ...
      SEED_PHRASE_MATCH: 'You\'re all set. Navigating to portfolio...',
      MODE_DEBIT_AND_ACH: 'Debit card and Instant ACH',
      COINBASE_DISPLAY_TITLE: 'Link Coinbase Account',
      SARDINE_DISPLAY_TITLE: 'Buy with USD',
      ...
      BALANCE: 'balance',
      FORM: 'from',
      INSUFFICIENT_BALANCE_BRIDGE: '* Amount that your trying to bridge is higher than your actual balance',
      ...
      UNABLE_TO_REVEAL_CARD_DETAILS: 'Unable to reveal card details. Please try again later.',
      ...
      OPTIONAL: '(optional)',
      BACK: 'Back',
      STARGAZE_COMING_SOON: 'Coming Soon 🎄',
      ...
      NEED_HELP: 'Need Help?',
      REFERRAL_CODE_COPY: 'Referral code copied',
      JWT: 'JWT',
      JWT_COPY: 'JWT copied to clipboard',
      COPIED_TO_CLIPBOARD: 'Copied to clipboard',
      CLICK_HERE_TO_VIEW_TRANSACTION: 'Click here to view transaction',
      ENETER_AMOUNT_LESS_THAN_BALANCE: 'Please enter an amount less than or equal to your balance',
      ...
      VOLUME_INIT_CAPS: 'Volume',
      MAXIMUM_SUPPLY_INIT_CAPS: 'Maximum supply',
      CURRENT_SUPPLY_INIT_CAPS: 'Current supply',
